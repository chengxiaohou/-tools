...
- (void)viewDidLoad {
    ...
    if (_cropRatio)
    {
        _scrollView.frame = CGRectMake(0, 0, Width, Width/_cropRatio);
    }
    // 未指定则用默认值
    else
    {
        _scrollView.frame = CGRectMake(0, 0 ,Width,Width);
    }
    
    _scrollView.center = CGPointMake(Width/2, Height/2);
...
- (void)centerContent {
    ...
    CGRect scrollBounds = CGRectMake(0, 0, Width, Width);
