...
@interface LGPhotoPickerBrowserViewController : UIViewController<LGPhotoPickerBrowserViewControllerDataSource>
...
//========================== 橙晓侯改装 自带数据源 ==========================
@property (nonatomic, strong) NSArray *LGPictures;
@end
