...
- (void)setupCollectionView{
    if (!_collectionView) {
        ...
        UICollectionView *collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, frame.size.width + LGPickerColletionViewPadding,Height) collectionViewLayout:flowLayout];
